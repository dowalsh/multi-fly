...
def main():
    ...
    destinations = [
        Location("London", "eyJzIjoiTE9ORCIsImUiOiIyNzU0NDAwOCIsImgiOiIyNzU0NDAwOCJ9="),
    ...
    for home in homes:
        for destination in destinations:
            ...
            if home == destination:
                continue
            itinerary_dict[(home, destination)] = get_round_trip(
                home, destination, departure_date, return_date
            )
    ...
    for destination in destinations:
        ...
        for home in homes:
            ...
            cheapest_itinerary = itinerary_dict[
                (home, destination)
            ].get_cheapest_itinerary()
